...
interface Item {
  ...
  description: string;
  header: string;
  input: string; // Änderung: Pfad zur PDF-Datei
}
...
export const pdfexamples: Item[] = [
  {
    ...
    description:
      "Click on this card to open the PDF about the federal parliament of Germany.You can download the PDF and then put it into this field",
    header: bundestag,
  ...
  },
  {
    ...
    description:
      "Click on this card to open the PDF about the Nasa.You can download the PDF and then put it into this field.",
    header: bundestag,
    input: nasa,
  },
  {
    ...
    description:
      "Click on this card to open the PDF about why the mars is perfect for us.You can download the PDF and then put it into this field.",
    header: bundestag,
    input: spacex,
  },
];
